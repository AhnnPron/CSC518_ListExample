...
import com.example.awesomefat.csc518_listexample.ATree;

public class AirportTreeViewActivity extends AppCompatActivity
{
    private ATree theTree;
    private Button leftButton, rightButton, foodButton;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        this.foodButton = this.findViewById(R.id.foodBT);
    ...
    public void onSearchRestaurantsButtonClicked(View v)
    {

        Intent i = new Intent(this, YelpRestaurantViewActivity.class);
        this.startActivity(i);
    }
